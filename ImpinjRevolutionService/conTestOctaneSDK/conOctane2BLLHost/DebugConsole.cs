...
namespace System.Diagnostics
{
	...
	public class DebugConsoleWrapper : System.Windows.Forms.Form
	{
        ...
        #region MJD thread-safe additions 2/12/2013
        ...
        private void OutputViewAdd(ListViewItem Elem)
        {
            ...
            else
            {
                    ...
                    {
                        ;//eat exception and keep rollin' - this exception seems to only occur while debugging while multiple calls are backing up.
                    }
